...
pub struct CliArgs {
    ...
    /// Share channel activity with current channel members.
    #[arg(
        long,
        env = "BUZZ_ACP_OBSERVER_CHANNEL_MEMBERS",
        default_value_t = false
    )]
    pub observer_channel_members: bool,
...
pub struct Config {
    ...
    pub relay_observer: bool,
    /// Share encrypted activity with current channel members.
    pub observer_channel_members: bool,
...
impl Config {
    ...
    pub fn from_args(mut args: CliArgs) -> Result<Self, ConfigError> {
        ...
        let config = Config {
            ...
            observer_channel_members: args.observer_channel_members,
